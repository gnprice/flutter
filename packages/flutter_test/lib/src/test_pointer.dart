...
class TestPointer {
  ...
  ]) : assert(!_downPointers.contains(pointer),
              'Test pointer $pointer used twice concurrently'),
       _buttons = buttons {
    switch (kind) {
  ...
  /// Throws an exception if any [TestPointer]s from the current test are
  /// still down.
  ///
  /// Specifically, this checks for any [TestPointer] instances that have
  /// become down since the last time this method was called, and are
  /// still down.
  ///
